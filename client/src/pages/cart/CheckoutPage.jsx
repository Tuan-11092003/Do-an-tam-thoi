...
import { requestGetCart, requestUpdateInfoCart, requestApplyCoupon } from '../../services/cart/cartService';
...
import { requestCreatePayment } from '../../services/payment/paymentService';
...
function CheckoutPage() {
    ...
    // Tự động điền thông tin khách hàng từ profile đã đăng nhập
    useEffect(() => {
        if (!dataUser || Object.keys(dataUser).length === 0) return;

        // Một số response có thể bọc info trong `user`, nên xử lý cả hai trường hợp
