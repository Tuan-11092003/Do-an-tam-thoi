                        ...
                        <Tooltip title="Chat với chúng tôi" placement="left">
                            <Badge count={unreadCount} offset={[-5, 5]}>
                                <Button
                                    ...
                                    size="large"
                                    onClick={toggleChat}
                                    className="!w-16 !h-16 !bg-gradient-to-br from-blue-400 to-blue-500 border-0 shadow-2xl hover:shadow-blue-400/50 hover:scale-110 transition-all duration-300"
                                    ...
                                    <div className="p-4 bg-white border-t border-gray-200">
                                        <div className="flex gap-2">
                                            <TextArea
                                                ...
                                                className="flex-1 rounded-xl border-gray-300 focus:border-blue-400 hover:border-blue-400"
                                            />
                                            <Button
                                                type="primary"
                                                shape="circle"
                                                ...
                                                className="!bg-gradient-to-br from-blue-400 to-blue-500 border-0 hover:shadow-lg transition-all flex-shrink-0 disabled:opacity-50"
                                            />
                                        </div>
